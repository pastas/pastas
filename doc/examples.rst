...
Jupyter Notebooks. Examples in the form of Python scripts can also be found on the `examples directory on GitHub <https://github.com/pastas/pastas/tree/master/examples>`_.
