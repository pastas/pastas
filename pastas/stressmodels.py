...
class StressModel(StressModelBase):
    ...
    def set_stress(
        ...
        settings: dict or str, optional
            The settings of the stress. This can be a string referring to a predefined
            settings dictionary (defined in ps.options.timeseries), or a dictionary
...
class WellModel(StressModelBase):
    ...
    settings: str, list of dict, optional
        ...
        ps.options.timeseries), or a dictionary with the settings to apply. For more
...
class RechargeModel(StressModelBase):
    ...
    settings: tuple of str or dict, optional
        ...
        referring to a predefined settings dict (defined in ps.options.timeseries),
    ...
    def set_stress(
        ...
        settings : str or dict, optional
            ...
            ps.options.timeseries), or a dict with the settings to apply. For more
...
class ChangeModel(StressModelBase):
    ...
    settings: dict or str, optional
        The settings of the stress. This can be a string referring to a predefined
        settings dict (defined in ps.options.timeseries), or a dict with the
