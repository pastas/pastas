...
class Linear(RechargeBase):
    ...
    def simulate(self, prec: Array_Like, evap: Array_Like, p: Array_Like, **kwargs) -> Array_Like:
    ...
    def get_water_balance(self, prec: Array_Like, evap: Array_Like, p: Array_Like, **kwargs) -> DataFrame:
        ea = multiply(evap, p)
...
class FlexModel(RechargeBase):
    ...
    def simulate(self, prec: Array_Like, evap: Array_Like, temp: Array_Like, p: Array_Like, dt: float = 1.0, return_full: bool = False, **kwargs) -> Array_Like:
    ...
    @staticmethod
    @njit
    def get_root_zone_balance(pe: Array_Like, ep: Array_Like, srmax: float = 250.0, lp: float = 0.25, ks: float = 100.0,
                              gamma: float = 4.0, dt: float = 1.0) -> Tuple[Array_Like]:
    ...
    @staticmethod
    @njit
    def get_interception_balance(pr: Array_Like, ep: Array_Like, simax: float = 2.0, dt: float = 1.0) -> Tuple[Array_Like]:
    ...
    @staticmethod
    @njit
    def get_snow_balance(prec: Array_Like, temp: Array_Like, tt: float = 0.0, k: float = 2.0) -> Tuple[Array_Like]:
    ...
    def get_water_balance(self, prec: Array_Like, evap: Array_Like, temp: Array_Like, p: Array_Like, dt: float = 1.0, **kwargs) -> DataFrame:
    ...
    def check_snow_balance(self, prec: Array_Like, temp: Array_Like, **kwargs) -> float:
        ss, ps, m = self.get_snow_balance(prec, temp)
        error = (ss[0] - ss[-1] + (ps + m).sum())
        return error

    def check_interception_balance(self, prec: Array_Like, evap: Array_Like, **kwargs) -> float:
        si, ei, pi = self.get_interception_balance(prec, evap)
        error = (si[0] - si[-1] + (pi + ei).sum())
        return error

    def check_root_zone_balance(self, prec: Array_Like, evap: Array_Like, **kwargs) -> float:
...
class Berendrecht(RechargeBase):
    ...
    def simulate(self, prec: Array_Like, evap: Array_Like, p: Array_Like, dt: Array_Like = 1.0, return_full: bool = False, **kwargs) -> Tuple[Array_Like]:
    ...
    @staticmethod
    @njit
    def get_recharge(prec: Array_Like, evap: Array_Like, fi: float = 1.0, fc: float = 1.0, sr: float = 0.5, de: float = 250.0, l: float = -2.0,
                     m: float = 0.5, ks: float = 50.0, dt: float = 1.0) -> Array_Like:
        """
    ...
    def get_water_balance(self, prec: Array_Like, evap: Array_Like, p: Array_Like, dt: float = 1.0, **kwargs) -> DataFrame:
...
class Peterson(RechargeBase):
    ...
    def simulate(self, prec: Array_Like, evap: Array_Like, p: Array_Like, dt: float = 1.0, return_full: bool = False, **kwargs) -> Array_Like:
        """Simulate the recharge flux.
    ...
    @staticmethod
    @njit
    def get_recharge(prec: Array_Like, evap: Array_Like, scap: float = 1.0, alpha: float = 1.0,
